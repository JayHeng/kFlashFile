...
**  Change History:
**
**  1.7.0 Support JESD216D, forced internal loopback mode, forced SPI mode
          Removed the AHB buffer configuration from API
**  1.6.0 Support JESD216B, Support PORTB, Support parallel mode
**  1.0.0 First implementation, support basic FLEXSPI NOR operation
**
*******************************************************************************/

//!@brief FLEXSPI NOR Driver Version
#define FLEXSPI_NOR_DRIVER_VERSION MAKE_VERSION(1, 7, 0)
...
enum
{
    kSerialNorOctaldMode_NoOctalEnableBit = 0,
    kSerialNorOctaldMode_HasOctalEnableBit = 1,
};
...
enum
{
    ...
    kSerialNorEnhanceMode_SpiMode = 6,
    kSerialNorEnhanceMode_ExtDqs = 8,
};
...
extern "C"
{
    ...
    //!@brief Program data to Serial NOR via FlexSPI specified by address and length
