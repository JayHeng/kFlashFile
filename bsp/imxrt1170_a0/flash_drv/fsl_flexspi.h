...
extern "C"
{
    ...
    //!@brief Update Clock source for FlexSPI
    extern status_t flexspi_update_clock_source(uint32_t instance, uint32_t source);
    ...
    extern void flexspi_update_padsetting(uint32_t instance, flexspi_mem_config_t *config, uint32_t driveStrength);

    extern bool is_flexspi_clock_enabled(uint32_t instance);
